  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fuwutupian" label="服务图片" prop="fuwutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fuwutupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fuwujieshao = this.ruleForm.fuwujieshao.replace(reg,'../../../springboot224bf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
