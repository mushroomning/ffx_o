    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="家庭住址" prop="jiatingzhuzhi">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiatingzhuzhi" label="家庭住址" prop="jiatingzhuzhi">
                    <span v-html="ruleForm.jiatingzhuzhi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="缴费情况" prop="jiaofeiqingkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaofeiqingkuang" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaofeiqingkuang" label="缴费情况" prop="jiaofeiqingkuang">
                    <span v-html="ruleForm.jiaofeiqingkuang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房屋信息" prop="fangwuxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fangwuxinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangwuxinxi" label="房屋信息" prop="fangwuxinxi">
                    <span v-html="ruleForm.fangwuxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房产资料" prop="fangchanziliao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fangchanziliao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangchanziliao" label="房产资料" prop="fangchanziliao">
                    <span v-html="ruleForm.fangchanziliao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	youxiang : false,
	jiatingzhuzhi : false,
	jiaofeiqingkuang : false,
	fangwuxinxi : false,
	fangchanziliao : false,
	zhaopian : false,
      },
      ruleForm: {
        yonghuming: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
          ...
          if(o=='jiaofeiqingkuang'){
            this.ruleForm.jiaofeiqingkuang = obj[o];
	    this.ro.jiaofeiqingkuang = true;
            continue;
          }
          if(o=='fangwuxinxi'){
            this.ruleForm.fangwuxinxi = obj[o];
	    this.ro.fangwuxinxi = true;
            continue;
          }
          if(o=='fangchanziliao'){
            this.ruleForm.fangchanziliao = obj[o];
	    this.ro.fangchanziliao = true;
            continue;
          }
          if(o=='zhaopian'){
	...
	this.ruleForm.jiatingzhuzhi = this.ruleForm.jiatingzhuzhi.replace(reg,'../../../springboot224bf/upload');
	this.ruleForm.jiaofeiqingkuang = this.ruleForm.jiaofeiqingkuang.replace(reg,'../../../springboot224bf/upload');
	this.ruleForm.fangwuxinxi = this.ruleForm.fangwuxinxi.replace(reg,'../../../springboot224bf/upload');
	this.ruleForm.fangchanziliao = this.ruleForm.fangchanziliao.replace(reg,'../../../springboot224bf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
